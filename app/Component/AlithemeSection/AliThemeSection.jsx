...
const AliThemeSection = () => {
    return (
        ...
        <div className='shadow-2xl bg-slate-800 pb-10'>
            ...
            <div className="grid  lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 lg:mx-40 md:mx-2 mx-10 pb-4">
                {/* <Fade duration={1000}> */}
                <div className="card lg:w-80 md:w-96 bg-white shadow-2xl">
                    <figure className="px-10 bg-white">
                        <Image src={Allfixer} alt="Shoes" className="p-10" />
                    </figure>
                ...
                <div className="card lg:w-80 md:w-96 bg-white shadow-2xl">
                    <figure className="px-10 bg-white">
                        <Image src={AppSet} alt="Shoes" className="p-10" />
                    </figure>
                    <div className="card-body items-center text-center">
                ...
                <div className="card lg:w-80 md:w-96 bg-white shadow-2xl">
                    <figure className="px-10  bg-white">
                        <Image src={Mobicom} alt="Shoes" className="p-10" />
                    </figure>
                    <div className="card-body items-center text-center">
