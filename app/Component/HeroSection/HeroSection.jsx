            ...
            <div className='lg:flex md:flex lg:flex-row md:flex-row flex-col items-center bg-gradient-to-r from-purple-700 via-purple-500 to-purple-700 lg:py-10 py-16 '>
                <div className='visible lg:invisible md:invisible lg:w-0 md:w-0 w-full lg:0 md:h-0   me-16 '>
                    ...
                    <Image
                        src={HeroImage}
                        alt="HeroImage"
                        className='lg:w-[40vw] lg:h-[85vh] md:h-[50vh]'
                    ></Image>
                ...
                <div className=' lg:w-[45vw] md:w-[40vw] w-[90vw] mx-auto flex flex-col  justify-center items-center text-white dark:text-black text-justify'>
                    ...
                    <span className='flex pt-6'>
                        <button className='btn btn-outline text-white dark:text-black'><BsPhone className='text-xl'></BsPhone>Available on <br /> AppStore</button>
                        <button className='btn btn-outline mx-4 text-white dark:text-black'><BiLogoPlayStore className='text-xl'></BiLogoPlayStore>Google Play</button></span>
